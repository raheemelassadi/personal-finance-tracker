...
function ExpenseList() {
  const [expenses, setExpenses] = useState([
    { name: "Groceries", amount: "$2200", isVisible: false },
    { name: "Rent", amount: "$3500", isVisible: false },
    { name: "Transport", amount: "$800", isVisible: false },
    // Add more expenses here if needed
  ]);

  const handleClick = (index) => {
    setExpenses((prevExpenses) => {
      const updatedExpenses = [...prevExpenses];
      updatedExpenses[index].isVisible = true;
